...
let make_swordsman loc =
  ...
  in
  Characters.update_character swd;
  swd
...
let make_mage loc =
  ...
  in
  Characters.update_character mg;
  mg
...
let make_lyn loc =
  ...
  in
  Characters.update_character lyn;
  lyn
...
let make_hector loc =
  ...
  in
  Characters.update_character hector;
  hector
...
let make_erk loc =
  ...
  in
  Characters.update_character erk;
  erk
